...
EasyInject is a lightweight Windows process injection tool built for research and educational purposes.
It provides a clean and modern interface for injecting DLL files, raw shellcode, or custom assembly payloads into running processes.
...
Do not use this software on systems or processes without proper authorization.
